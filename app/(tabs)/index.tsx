...
const styles = StyleSheet.create({
  ...
  occasionScroll: {
    paddingRight: AppTheme.spacing['margin-mobile'],
    gap: AppTheme.spacing.sm,
    marginBottom: AppTheme.spacing.md,
  },
  occasionChip: {
  ...
  boldAvoid: {
    fontFamily: AppTheme.typography['headline-md'].fontFamily,
    color: AppTheme.colors['on-error-container'],
  },
  tipBox: {
    backgroundColor: AppTheme.colors['primary-fixed'],
    borderRadius: AppTheme.rounded.md,
    padding: AppTheme.spacing.sm,
    marginTop: AppTheme.spacing.base,
  },
  tipText: {
    ...AppTheme.typography['body-md'],
    color: AppTheme.colors['on-primary-fixed-variant'],
  },
  boldTip: {
    fontFamily: AppTheme.typography['headline-md'].fontFamily,
    color: AppTheme.colors['on-primary-fixed'],
  },
